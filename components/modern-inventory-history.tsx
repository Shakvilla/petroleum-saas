...
export function ModernInventoryHistory({ tenant }: ModernInventoryHistoryProps) {
  const transactions = [
    {
      id: "TXN001",
      type: "Delivery",
      ...
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-gray-50">
        <CardHeader>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <Button variant="outline" className="h-12 px-6 bg-white/50 border-gray-200 hover:bg-white rounded-xl">
          ...
          <div className="space-y-4">
            {transactions.map((transaction) => {
              ...
              return (
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-r ${transaction.bgGradient} opacity-30`}></div>
                  ...
                  <CardContent className="relative p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0 space-y-3">
                          <div className="flex flex-wrap items-center gap-2">
                            <h3 className="font-bold text-gray-900 text-lg">{transaction.tank}</h3>
                      ...
                      <div className="text-right flex-shrink-0">
                        <div className={`text-2xl font-bold ${amountInfo.color} mb-1`}>
                          {amountInfo.sign}
