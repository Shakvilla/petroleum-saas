...
import { AlertTriangle, Clock, CheckCircle, X, Bell, BellOff, Zap, Fuel, Shield } from "lucide-react"
  ...
  const alerts = [
    {
      ...
      description: "Tank level has dropped below 20%. Immediate refill required to avoid stockout.",
      tank: "T004",
    ...
    },
    {
      ...
      description: "Tank level is at 21%. Schedule refill within 3 days to maintain operations.",
      tank: "T002",
    ...
    },
    {
      ...
      description: "IoT sensor IOT003 has been offline for 2 hours. Check connection and battery status.",
      tank: "T002",
    ...
    },
    {
      ...
      description: "Tank T001 temperature reading outside normal range. Monitor for safety compliance.",
      tank: "T001",
    ...
    },
    {
      ...
      description: "Motion detected in restricted area after hours. Security team has been notified.",
      tank: "N/A",
    ...
    },
    {
      ...
      description: "Primary monitoring system switched to backup due to scheduled maintenance.",
      tank: "All",
      timestamp: "1 day ago",
      status: "resolved",
      priority: "low",
      ...
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-gray-50">
        ...
        <CardContent className="space-y-6">
          {alerts.map((alert) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-r ${alert.bgGradient} opacity-30`}></div>

              <CardContent className="relative p-6">
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    <div className={`p-3 bg-gradient-to-br ${alert.gradient} rounded-2xl shadow-lg flex-shrink-0`}>
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    {alert.status === "active" && (
                      <>
                        <Button size="sm" variant="outline" className="bg-white/50 border-gray-200 hover:bg-white">
                          Acknowledge
                        </Button>
                        <Button
                          size="sm"
